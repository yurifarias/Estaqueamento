...
public class SimetriaPorDoisPlanos extends CalcularEstaqueamentoAuxiliar {
    ...
    protected Matrix calcularEsforcosTransformados() {
        ...
        double[][] esforcos = {{MainActivity.esforcoFx}, {MainActivity.esforcoFy}, {MainActivity.esforcoFz},
                {MainActivity.esforcoFa}, {MainActivity.esforcoFb}, {MainActivity.esforcoFc}};
