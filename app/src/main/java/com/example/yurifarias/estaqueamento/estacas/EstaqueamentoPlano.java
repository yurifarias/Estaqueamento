...
public class EstaqueamentoPlano extends CalcularEstaqueamentoAuxiliar {
    ...
    protected Matrix reduzirMatrizCompontesEstacas(char caso) {
        ...
        double[][] matriz = new double[3][MainActivity.qtdEstacas];
    ...
    protected Matrix montarMatrizEsforcosReduzidos(char caso) {

        double[][] matriz = new double[3][1];

        if (caso == 'B') {

            matriz[0][0] = MainActivity.esforcoFx;
            matriz[1][0] = MainActivity.esforcoFy;
            matriz[2][0] = MainActivity.esforcoFc;

        } else if (caso == 'C') {

            matriz[0][0] = MainActivity.esforcoFx;
            matriz[1][0] = MainActivity.esforcoFz;
            matriz[2][0] = MainActivity.esforcoFb;
        }
