...
public class SimetriaPorUmEixo extends CalcularEstaqueamentoAuxiliar {
    ...
    protected void subdividirMatrizCompontesEstacas() {

        double[][] matriz1 = new double[2][MainActivity.qtdEstacas];
        double[][] matriz2 = new double[4][MainActivity.qtdEstacas];
    ...
    protected void subdividirMatrizRigidez() {
    ...
    protected void subdividirMatrizEsforcos() {
        ...
        matriz2[1][0] = MainActivity.esforcoFz;
        matriz2[2][0] = MainActivity.esforcoFb;
        matriz2[3][0] = MainActivity.esforcoFc;
    ...
    protected void acharNovasCoordenadas1() {
    ...
    protected Matrix montarTensorTransformacao1() {
    ...
    protected Matrix calcularComponentesSubTransformados1() {
    ...
    protected Matrix calcularRigidezTransformada1() {
    ...
    protected Matrix calcularEsforcosSubTransformados1() {
    ...
    como aritifício para solucionar casos de estaqueamento simétrico por um plano. */
    protected void acharNovasCoordenadas2() {
    ...
    referente aos casos de estaquemaneto com simetria por um eixo */
    protected Matrix montarTensorTransformacao2() {
    ...
    transformação [T], retornando duas matrizes 4 x n: [p''] = [T] * [p'],
    onde n é número de estacas */
    protected Matrix calcularComponentesSubTransformados2() {
    ...
    /* Método para calcular a matriz de rigidez transformada [S''], aplicando o tensor de transformação [T],
    retornando uma matriz 4 x 4: [S''] = [T] * [S'] * [T]transposta */
    protected Matrix calcularRigidezTransformada2() {
    ...
    /* Método para calcular a matriz de esforços transformados [F''], aplicando o tensor de transformação [T],
     retornando uma matriz 4 x 1: [F''] = [T] * [F'] */
    protected Matrix calcularEsforcosSubTransformados2() {
    ...
    protected void subdividirMatrizCompontesEstacas2() {
    ...
    protected void subdividirMatrizRigidez2() {
    ...
    protected void subdividirMatrizEsforcos2() {
    ...
    protected Matrix somarReacoesNormais() {
        ...
        double[][] matriz1 = (matrizComponentesEstacasSubdividida1.transpose()).times(matrizMovElastico1).getArray();
        double[][] matriz2 = (matrizComponentesEstacasSubdividida3.transpose()).times(matrizMovElasticoSubTransformado3).getArray();
        double[][] matriz3 = (matrizComponentesEstacasSubdividida4.transpose()).times(matrizMovElasticoSubTransformado4).getArray();
